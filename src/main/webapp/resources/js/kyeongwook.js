...
var COUPON_FORM = '<div id="container" class="box">' + '<div id="content">'
      ...
      + app.img()
      + '/coupon/couponbook_tit_n.gif" alt="쏘카 쿠폰북 - 쏘카 회원에게 드리는 쏘카 쿠폰으로 알뜰하게 카셰어링하세요!"></h2>'
      + '<div class="couponbook">'
      + '<div class="couponbook_cont">'
      + '<div class="box_tit"><h3 style="margin-right:90%"><img src="'
      + app.img()
      + '/coupon/couponbook_tit01.png" alt="반짝쿠폰"></h3></div>'
      + '<ul class="list_couponbook">';
var COUPON_LI = 
        '<li>'
      + '<div class="thumb"style="height:100px">'
      + '<img src="'+ app.img()+ '/coupon/brunch_web_img_thumb.jpg" style="max-width: 100%; height: auto;" alt="ap2/coupon/brunch_web_img_thumb.jpg">'
      + '</div>'
      + '<div class="cont">'
...
var COUPON_END =       
      ...
      + app.img()
      + '/coupon/couponbook_tit02.png" alt="베이직쿠폰"></h3></div>'
      + '<div class="box_tit box_line"><h3><img src="'
      + app.img()
      + '/coupon/tit_more.gif" alt=""></h3><a href="http://blog.socar.kr/646" target="_blank" class="right"><img src="'
      + app.img()
      + '/coupon/couponbook_tit_more.png" alt=""></a></div>'
      + '<ul class="b_list">'
      + '<li class="fst">'
      + '<div class="thumb"><img src="'
      + app.img()
      + '/coupon/b_thumb01_n.png" alt=""></div>'
      ...
      + '<div class="thumb"><img src="'
      + app.img()
      + '/coupon/b_thumb02_n.png" alt=""></div>'
      ...
      + '<div class="thumb"><img src="'
      + app.img()
      + '/coupon/b_thumb03_n.png" alt=""></div>'
         ...
         $.getJSON(app.context() + '/coupon/list', function(data){
            $.each(data.list, function(i, coupon){
               ...
               coupon_content +=
                    '<li>'
                  + '<div class="thumb"style="height:100px">'
                  + '<img src="'+ app.img() + '/coupon/'+coupon.imgName+'"style="max-width: 100%; height: auto;" alt="쿠폰 이미지">'
                  + '</div>'
                  + '<div class="cont">'
                  + '<div class="tit_cont"style="margin-top:20%">'
